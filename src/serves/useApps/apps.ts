...
const apps: CkbApp[] = [
    ...
    },
    {
        ...
        description: {
            ...
            zh: 'Omiga 是第一个基于 CKB 的铭文协议，也是一个支持 xUDT、DOB 的订单簿 DEX'
        }
    },
    {
    ...
    },
    {
        ...
        url: 'https://haste.pro',
        description: {
            zh: 'Haste是一个资产管理器，可以方便地管理您在 Bitcoin/RGB++/CKB 上的加密资产',
    ...
    },
    {
        ...
        description: {
            zh: 'Dobby 是 Bitcion 上的数码物（DOBs）去中心化交易平台',
    ...
    },
    {
        ...
        description: {
            ...
            zh: '一个完全在链上的 AI 游戏，为用户提供创建、组合和进化数字生活的能力。',
        }
    },
    {
    ...
    },
    {
        ...
        description: {
            ...
            zh: 'CKB 主网上的第一个可交易资产和第一个 DOBs（数字对象）',
        }
    },
    {
    ...
    },
    {
        ...
        description: {
            ...
            zh: '基于 RGB++ 协议和 DOBs 的 AW（自主世界）游戏。',
        }
    },
    {
