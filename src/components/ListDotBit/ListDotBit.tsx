...
export default function ListDotBit({data, status}: {data: string[]; status: string}) {
...
function DOBItem({item}: {item: string}) {
  return (
    ...
    >
      <div className="relative w-full h-[140px] sm:h-[200px] md:h-[250px] lg:h-[180px]  overflow-hidden rounded-sm relative border border-1">
        <img className="object-cover w-full h-full" src={'/images/dotbit.png'} alt="" />
