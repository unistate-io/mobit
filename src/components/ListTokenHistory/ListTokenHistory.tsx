                                    ...
                                    item.attributes.display_inputs.map((input) => {
                                        if (input.xudt_info) {
                                            return <div key={input.id} className="flex flex-row text-xs justify-between mb-2">
                                                <div className="text-[#6CD7B2]">
                                                    <CopyText copyText={input.address_hash}>
                                                        {shortTransactionHash(input.address_hash, 4)} xudt_info
                                                    </CopyText>
                                                </div>
                                            ...
                                            return <div key={input.id} className="flex flex-row text-xs justify-between mb-2">
                                                ...
                                                <div className="flex flex-row items-center font-semibold">
                                                    {toDisplay(input.extra_info.amount, Number(input.extra_info.decimal))} {input.extra_info.symbol}
                                                </div>
                                            </div>
                                        } else {
                                            return <div key={input.id} className="flex flex-row text-xs justify-between mb-2">
