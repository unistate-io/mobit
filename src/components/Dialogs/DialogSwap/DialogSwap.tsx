                ...
                <div className="h-full overflow-auto max-h-[88vh] w-full">
                            ...
                            <div className="flex flex-col py-5 border rounded-2xl mb-4">
                                <div className="flex flex-row items-center justify-between mb-2 px-5">
                                    ...
                                    <div className="text-sm">
                                        {lang['Balance']}: <span className="font-semibold">
                                            {swapForm.selectedX ?
                                ...
                                <div className="flex flex-row items-center px-5 justify-between">
                                    ...
                                    <div
                                        className="min-w-[120px]  md:min-w-[160px] grow-0">
                                        <Select
                        ...
                        <div className="shadow rounded-xl py-3">
                            ...
                            <div className="flex flex-row items-center justify-between px-6 mb-4">
                                {!!swapForm.pool && swapForm.amountX ?
                                    <>
                                        <div
                                            className="text-sm">{lang['Fee']} <span>{`(${((swapForm.pool as any).poolInfo.feeRate / 10000).toFixed(3)}%)`}</span>
                                        </div>
                    ...
                    {step === 2 &&
                        <>
                            ...
                            <div className="text-center text-sm">{lang['The transaction is sent and will be confirmed later']}
                            </div>
