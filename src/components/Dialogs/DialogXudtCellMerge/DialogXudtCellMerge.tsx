            ...
            {step === 1 && (
              <>
                            ...
                            <div className="flex flex-row items-center p-2">
                              ...
                              <div className="text-sm">
                                ...
                                <div className="font-semibold">
                                  {toDisplay(number.Uint128LE.unpack(cell.data).toString(), xudt?.decimal || 0, true)}
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div className="min-h-6 mt-4 mb-2 font-semibold">
                  {lang['Fee']}: <span className="font-normal">{fee}</span> CKB
                </div>
                ...
                <div className="flex flex-row mt-4">
                  ...
                  <Button
                    ...
                    btntype={'primary'}
                    loading={sending || building || status === 'loading'}
