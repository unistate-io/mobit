...
export default function DialogCkbTransfer({
  children,
  froms,
  className,
}: {
            ...
            {step === 1 && (
              <>
                ...
                <div className="font-semibold mb-10">
                  ...
                  <Input
                    startIcon={<img width={32} height={32} src={TokenIcons['CKB']} alt="CKB" />}
                    value={'CKB'}
                    type={'text'}
                    disabled
                  />
                ...
                <div className="font-semibold mb-10">
                  <div className="mb-2 flex-row flex items-center justify-between">
                    ...
                    <div className="font-normal">
                      ...
                      {CkbBalance ? toDisplay(CkbBalance.amount, 8, true, 8) : '--'}
                    </div>
                  </div>
                  <Input
                ...
                <Button btntype={'primary'} loading={status === 'loading' || sending} onClick={handleTransfer}>
                  Continue
                </Button>
              </>
            )}
              ...
              <>
                ...
                <div className="mb-10">
                  ...
                  <div className="flex flex-row flex-nowrap justify-between items-center text-sm">
                    <div className="flex flex-row flex-nowrap items-center">{lang['To Address']}</div>
                  ...
                  <Select
                    ...
                    options={[
                      {
                        id: '1000',
                        label: `${fee(1000)} CKB (Slow: 1000 shannons/KB)`,
                      },
                      {
                        id: '2000',
                        label: `${fee(2000)} CKB (Standard: 2000 shannons/KB)`,
                      },
                      {
                        id: '3000',
                        label: `${fee(3000)} CKB (Fast: 3000 shannons/KB)`,
                      },
                    ]}
                    onValueChange={value => {
            ...
            {step === 3 && (
              <>
                ...
                <div className="my-4 p-3 bg-gray-100 rounded-lg">
                  ...
                  <div className="flex flex-row flex-nowrap justify-between text-sm mb-2">
                    <div className="text-gray-500">{lang['Total amount']}</div>
                    <div className="font-semibold">
                      {BigNumber(BigNumber(formData.amount))
                        .multipliedBy(10 ** 8)
                        .eq(CkbBalance ? CkbBalance.amount : 0)
