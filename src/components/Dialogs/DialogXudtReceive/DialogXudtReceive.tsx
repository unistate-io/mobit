...
export default function DialogXudtReceive(props: {children: React.ReactNode; address: string; className?: string}) {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger className={props.className}>{props.children}</Dialog.Trigger>
      <Dialog.Portal>
        ...
        >
          <div className="h-full overflow-auto max-h-[88vh] w-full">
            <div className="flex flex-row justify-between items-center mb-4">
              <div className="font-semibold text-2xl">{lang['Receive']}</div>
              <div
                onClick={e => {
                  setOpen(false);
                }}
            ...
            <div className="flex flex-col items-center justify-center w-[300px] py-6">
              <div className="rounded-xl bg-gray-800 p-3 mb-4 ">
                ...
                <div className="text-white text-center font-semibold mt-2">{lang['Scan to Transfer']}</div>
              </div>
