...
export default function DialogXudtTransfer({
    ...
    const fee1000 = useMemo(() => {
        ...
        return BigNumber(fee).dividedBy(10 ** 8).toString()
                    ...
                    <div className="h-full overflow-auto max-h-[88vh] w-full">
                                ...
                                <div className="font-semibold mb-10">
                                    <div className="mb-2 flex-row flex items-center justify-between">
                                        ...
                                        <div className="font-normal"><span
                                            className="text-gray-500"> {lang['Balance']}:</span> {xudtBalance ? toDisplay(xudtBalance.amount, token.decimal, true) : '--'}
                                        </div>
                                    </div>
...

                        {
                            ...
                            <>
                                ...
                                <div className="mb-10">
                                    ...
                                    <div
                                        className="flex flex-row flex-nowrap justify-between items-center mb-2 text-sm">
...

                        {
                            ...
                            <>
                                ...
                                <div
                                    className="text-center text-sm">{lang['The transaction is sent and will be confirmed later']}
                                </div>
