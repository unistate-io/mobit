          ...
          <div className="h-full overflow-auto max-h-[88vh] w-full">
            ...
            {step === 1 && (
              <div>
                ...
                <div className="mt-4">
                  {lang['Balance']}: {status === 'complete' ? toDisplay(balance, xudt?.decimal || 0, true) : '--'}{' '}
                  {xudt?.symbol}
                </div>
                ...
                <div className="flex flex-row mt-4">
                  ...
                  <Button btntype={'primary'} loading={status === 'loading' || sending} onClick={nextStep}>
                    {lang['Next']}
                  </Button>
                </div>
              </div>
            ...
            {step === 2 && (
              <>
                              ...
                              <div className="flex flex-row items-center p-2">
                                ...
                                <div className="text-sm">
                                  ...
                                  <div className="font-semibold">
                                    {toDisplay(Number(cell.cellOutput!.capacity).toString(), 8, true)}
                                  </div>
                                </div>
                              </div>
                            )}
                            {!!cell.cellOutput?.type && (
                              <div className="flex flex-row items-center p-2">
                                ...
                                <div className="text-sm">
                                  ...
                                  <div className="font-semibold">
                                    {toDisplay(
                                      number.Uint128LE.unpack((cell as any).outputData).toString(),
                                      xudt?.decimal || 0,
                                      true
                                    )}
                                  </div>
                    ...
                    {!!rawTx ? (
                      rawTx.outputs.map((cellOutput: any, index) => {
                        return (
                          ...
                          >
                            <div className="flex flex-row items-center bg-gray-50 p-2 text-xs overflow-hidden">
                              {toDisplay(Number(cellOutput.capacity).toString(), 8, true)} CKB
                            </div>
                            {!!cellOutput.type && (
                              <div className="flex flex-row items-center p-2">
                                <TokenIcon size={28} symbol={xudt?.symbol || ''} />
                                <div className="text-sm">
                                  ...
                                  <div className="font-semibold">
                                    {toDisplay(
                                      number.Uint128LE.unpack((rawTx! as any).outputsData[index]).toString(),
                                      xudt?.decimal || 0,
                                      true
                                    )}
                                  </div>
                            ...
                            {!cellOutput.type && (
                              <div className="flex flex-row items-center p-2">
                                ...
                                <div className="text-sm">
                                  <div>CKB</div>
                                  <div className="font-semibold">
                                    {toDisplay(cellOutput.capacity.toString(), 8, true)}
                                  </div>
                                </div>
                              </div>
                            )}
                ...
                <div className="flex flex-row mt-4">
                  ...
                  <Button btntype={'primary'} loading={sending || status === 'loading'} onClick={handleSignAndSend}>
                    {lang['Burn']}
                  </Button>
                </div>
              </>
