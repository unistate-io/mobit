                ...
                <div className="font-semibold mb-10">
                  <div className="mb-2 flex-row flex items-center justify-between">
                    ...
                    <div className="font-normal">
                      ...
                      {xudtBalance ? toDisplay(xudtBalance.amount, xudtBalance.decimal, true) : '--'}
                    </div>
                  </div>
                  <Input
            ...
            {step === 2 && (
              <>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-row flex-nowrap justify-between items-center text-sm mb-4">
                    <div className="flex flex-row flex-nowrap items-center">{lang['From Address']}</div>
                  ...
                  <div className="flex flex-row flex-nowrap justify-between items-center mb-4 text-sm">
                    <div className="flex flex-row flex-nowrap items-center">{lang['BTC Fee Rate']}</div>
