...
export default function DialogLeapXudtToLayer2CanSelectToken({children, className}: {
    ...
    const tokenList = useMemo(() => {
        return xudtsBalance.map(token => ({id: token.symbol, label: token.symbol, ...token}))
    }, [xudtsBalance])
                ...
                <div className="h-full overflow-auto max-h-[88vh] w-full">
                    {step === 1 && <>
                        ...
                        <div className="mb-2 flex-row flex items-center justify-between">
                                ...
                                <div className="font-normal"><span
                                    className="text-gray-500"> {lang['Balance']}: </span> {token ? toDisplay(balance, token!.decimal, true) : '--'}
                                </div>
                            </div>
...

                    {
                        ...
                        <>
                            ...
                            <div
                                className="text-center text-sm">{lang['The leap action will be completed after this transaction has been confirmed by more than']}
                                <b>6 {lang['blocks']}</b></div>
