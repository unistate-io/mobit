        ...
        <Dialog.Root open={open} onOpenChange={setOpen}>
            ...
            <Dialog.Portal>
                ...
                >
                    ...
                    {!address && !internalAddress && <div>{lang["Not Wallet founded"]}</div>}
                    ...
                    {!!address && !!internalAddress && (
                        <>
                                ...
                                <div className="flex-1 ml-6">
                                    ...
                                    {internalAddress !== address && (
                                        <CopyText copyText={internalAddress}>
                                            {shortTransactionHash(internalAddress, 8)}
                                        </CopyText>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-row items-center mt-6">
                                <Button className="mr-4 text-red-500" onClick={disconnect}>
                                    {lang["Disconnect"]}
                                </Button>
                                <Button
                                    onClick={e => {
                                    ...
                                    className="!bg-[#000]  hover:opacity-[0.8] text-white"
                                >
                                    {lang["OK"]}
                                </Button>
                            </div>
