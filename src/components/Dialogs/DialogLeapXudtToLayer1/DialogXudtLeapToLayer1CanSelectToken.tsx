          ...
          <div className="h-full overflow-auto max-h-[88vh] w-full">
                          ...
                          >
                            ...
                            <div className="flex flex-row items-center p-2">
                              ...
                              <div className="text-sm">
                                <div>BTC</div>
                                <div className="font-semibold">{toDisplay(uxto.value.toString(), 8, true)}</div>
                              </div>
                            </div>
                          </div>
                        );
            ...
            {step === 3 && (
              <>
                <div className="flex flex-row flex-nowrap justify-between items-center mb-4 mt-8 text-sm">
                  ...
                  <div>{address ? <ProfileAddresses addresses={[address]} defaultAddress={address} /> : '--'}</div>
                </div>
                <div className="flex flex-row flex-nowrap justify-between items-center mb-4 text-sm">
                  ...
                  <div>
                    {toBtcAddress ? (
                      <ProfileAddresses addresses={[toBtcAddress]} defaultAddress={toBtcAddress} />
                    ) : (
                      '--'
                    )}
                  </div>
                ...
                <div className="my-4 p-3 bg-gray-100 rounded-lg">
                  ...
                  <div className="flex flex-row flex-nowrap justify-between text-sm mb-2">
                    ...
                    <div className="font-semibold">
                      {address ? <ProfileAddresses addresses={[address]} defaultAddress={address} /> : '--'}
                    </div>
                  </div>
                  <div className="flex flex-row flex-nowrap justify-between text-sm mb-2">
            ...
            {step === 6 && (
              <>
                ...
                <div className="font-semibold text-center text-lg mb-2">{lang['Transaction Sent !']}</div>
