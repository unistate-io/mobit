  ...
  return (
    ...
    >
      <div className="flex flex-row items-center mr-1 cursor-pointer hover:text-[#6cd7b2]">
        ...
        <RadixSelect.Trigger
          className={`SelectTrigger-${id.current} flex flex-row items-center justify-between w-full outline-0`}
          aria-label={'Select'}
        >
          {addresses.length > 1 && (
            <RadixSelect.Icon className="SelectIcon ml-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
                ...
                <path
                  d="M17.5429 21.1293C16.7429 22.0992 15.2571 22.0992 14.4571 21.1293L10.0389 15.7726C8.963 14.4681 9.89089 12.5 11.5818 12.5L20.4182 12.5C22.1091 12.5 23.037 14.4681 21.9611 15.7726L17.5429 21.1293Z"
                  fill="#7B7C7B"
                />
              </svg>
            </RadixSelect.Icon>
                ...
                return (
                  <SelectItem key={address} value={address}>
                    <div className="flex items-center flex-row">
                      <div
                        className={`mr-1 flex items-center flex-row rounded font-semibold text-xs px-1 h-[20px] ${label.className}`}
                      >
                        {label.label}
                      </div>
