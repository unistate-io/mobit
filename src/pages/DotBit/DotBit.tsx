        ...
        <div className="max-w-[--page-with] mx-auto px-3 py-8 flex md:flex-row flex-col flex-nowrap items-start mb-10">
            <div className="md:w-[320px] w-full shadow rounded-lg overflow-hidden">
                <div className="w-full h-[320px] relative">
                    <img className="w-full h-full object-cover" src={"/images/dotbit.png"} alt="" />
                </div>
                <div className="p-4">
                    {status === "loading" && (
                        <>
                    ...
                    {status !== "loading" && !!data && <div className="font-semibold text-3xl">{domain}</div>}
                </div>
            </div>
                ...
                {status !== "loading" && data && (
                    <>
                        ...
                        <div className="text-sm mb-6">
                            ...
                            <div className="flex flex-row items-center text-sm font-semibold break-all">DID</div>
                        </div>

                        <div className="text-sm mb-6">
                            <div className="text-sm mb-3">{lang["Owner"]}</div>
                            <div className="flex flex-row items-center text-sm font-semibold break-all">
                                <CopyText copyText={data.owner_key}>
                                    {shortTransactionHash(data.owner_key, 10)}
                                </CopyText>
                            </div>
                        </div>
                        ...
                        <div className="text-sm mb-6">
                            ...
                            <div className="flex flex-row items-center text-sm font-semibold break-all">
                                <CopyText copyText={data.manager_key}>
                                    {shortTransactionHash(data.manager_key, 10)}
                                </CopyText>
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                {data.records.map((record, index) => {
                                    if (record.key.includes("address")) {
                                        ...
                                        return (
                                            <div
                                                className="flex flex-row items-center px-4 py-3 rounded-lg bg-gray-100 mb-3"
                                                key={index}
                                            >
                                                ...
                                                <div className="text-sm ml-3">
                                                    <CopyText copyText={record.value}>
                                                        {shortTransactionHash(record.value, 6)}
                                                    </CopyText>
                                                </div>
                                            </div>
                                        )
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="text-sm ml-3">
                                                    <CopyText copyText={record.value}>{record.value}</CopyText>
                                                </div>
                                            </div>
                                        )
                                    }
