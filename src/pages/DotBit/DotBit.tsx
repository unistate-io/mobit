              ...
              <>
                ...
                {data.records.map((record, index) => {
                  if (record.key.includes('address')) {
                    ...
                    return (
                      <div className="flex flex-row items-center px-4 py-3 rounded-lg bg-gray-100 mb-3" key={index}>
                        ...
                        <div className="text-sm ml-3">
                          <CopyText copyText={record.value}>{shortTransactionHash(record.value, 6)}</CopyText>
                        </div>
                      </div>
                    );
                  } else {
