...
export default function MarketPage() {
    ...
    const {btcAddress} = useContext(RoochContext)
    ...
    return <div className="max-w-[--page-with] mx-auto px-3 mt-4 md:mt-10 mb-10">
        <div className="py-9 mb-4 px-4 flex flex-col justify-center items-center shadow rounded-lg overflow-hidden"
            ...
            <div className="font-semibold text-xl text-center mb-4"
                 dangerouslySetInnerHTML={{__html: lang['Effortlessly and securely transfer assets between Bitcoin and CKB']}}></div>
            <div
                className="text-[#7B7C7B] text-sm mb-4">{lang['Enjoying a seamless cross-chain experience with RGB++ Leap functionality!']}</div>
            {
                !btcAddress && <DialogConnectWallet>
                    <button
